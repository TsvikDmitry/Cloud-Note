...
public class Fragment_Notebook_View extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		button_task_add.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				Main.OpenFragment(Main.IndexNotebookTaskAdd);
		...
		button_list_add.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				Main.OpenFragment(Main.IndexNotebookListAdd);
	...
	public static void rowList(TableLayout TableTask, final String id_task,
		...
		Layout.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				Main.OpenFragment(Main.IndexNotebookListEdit);
	...
	public static void rowTask(TableLayout TableTask, final String id_task,
		...
		Layout.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				Main.setSetting(Main.ID_TASK, id_task);
				Main.OpenFragment(Main.IndexNotebookTaskEdit);
	...
	public void onResume() {
		...
		Log("onResume");
		onUpdate();
		Main.setSetting(Main.ID_FRAGMENT, Main.IndexNotebookView);
