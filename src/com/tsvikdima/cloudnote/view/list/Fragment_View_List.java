...
public class Fragment_View_List extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		/*
		 * //для списков Button text_task_add = (Button)
		 * view.findViewById(R.id.button_click);
		 * text_task_add.setText("Добавить заметку"); Drawable img =
		 * context.getResources().getDrawable( Main.IconTaskAdd); img.setBounds(
		 * 0, 0, 80, 100 ); text_task_add.setCompoundDrawables( img, null, null,
		 * null ); //для заметок Button text_task_add = (Button)
		 * view.findViewById(R.id.button_click);
		 * text_task_add.setText("Добавить заметку"); Drawable img =
		 * context.getResources().getDrawable( Main.IconTaskAdd); img.setBounds(
		 * 0, 0, 80, 100 ); text_task_add.setCompoundDrawables( img, null, null,
		 ...
		 * 
		 * 
		 * //для корзины Button text_task_add = (Button)
		 * view.findViewById(R.id.button_click);
		 * text_task_add.setText("Очистить корзину"); Drawable img =
		 * context.getResources().getDrawable( Main.IconBasket); img.setBounds(
		 * 0, 0, 80, 100 ); text_task_add.setCompoundDrawables( img, null, null,
		 * null );
		 */
	...
	public static void onUpdate() {
		...
		try {
			...
			tasks = DropboxSunc.mTable.getTableTaskORList(true);
