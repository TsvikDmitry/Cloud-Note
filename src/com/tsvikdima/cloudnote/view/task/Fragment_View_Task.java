...
public class Fragment_View_Task extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		tableNote_3 = (TableLayout) view.findViewById(R.id.Table_3);
		 ...
		 LinearLayout layout_list_add = (LinearLayout) view.findViewById(R.id.layout_click);
		 layout_list_add.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {

				Main.OpenFragment(Main.IndexViewTaskAdd);
		 ...
		 //для заметок
		 Button text_add = (Button) view.findViewById(R.id.button_click);
		 text_add.setText("Добавить заметку");
		 Drawable img = context.getResources().getDrawable( Main.IconTaskAdd);
		 img.setBounds( 0, 0, 80, 100 );
		 text_add.setCompoundDrawables( img, null, null, null ); 
		 
	
		 /*
		 //для списков
		 Button text_task_add = (Button) view.findViewById(R.id.button_click);
		 text_task_add.setText("Добавить список");
		 Drawable img = context.getResources().getDrawable( Main.IconListAdd);
		 img.setBounds( 0, 0, 80, 100 );
		 ...
		 Drawable img = context.getResources().getDrawable( Main.IconBasket);
		 img.setBounds( 0, 0, 80, 100 );
		 text_task_add.setCompoundDrawables( img, null, null, null ); 
		 */
	...
	public static void onUpdate() {
		...
		try {
			//tasks = DropboxSunc.mTable.getTableTaskIdNote(Main.getSetting(Main.ID_NOTE));
			tasks = DropboxSunc.mTable.getTableTaskORList(false);
	...
	public static void rowList(TableLayout TableTask, final String id_task,
		...
		for (final Table.ListItem list : lists) {
			...
			CheckBox check_button = (CheckBox) row2.findViewById(R.id.check_button);
			if (list.isCheck()){
	...
	public static void rowTask(TableLayout TableTask, final String id_task,
		...
		Layout.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				Main.setSetting(Main.ID_TASK, id_task);
				Main.OpenFragment(Main.IndexViewTaskEdit);
	...
	public void onResume() {
		...
		Log("onResume");
		onUpdate();
		Main.setSetting(Main.ID_FRAGMENT, Main.IndexViewTask);
	...
	protected static void onDialog(final String id) {
		...
		for (final Table.Task task : tasks) {
			if (task.isFavorite()) {
				mCatsName = new String[] { "Удалить из избранных",
						"Добавить в корзину" };
			} else {
				mCatsName = new String[] { "Добавить в избранные",
						"Добавить в корзину" };
			}
